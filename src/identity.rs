...
extern "C" {
    ...
    async fn launch_webauth_flow(this: &Identity, details: &JsValue) -> Result<JsValue, JsValue>;

    #[wasm_bindgen(method, catch, js_name = getAuthToken)]
    fn get_auth_token(this: &Identity) -> Result<(), JsValue>;

    #[wasm_bindgen(method, catch, js_name = getAuthToken)]
    fn get_auth_token_with_details(this: &Identity, details: &JsValue) -> Result<(), JsValue>;

    #[wasm_bindgen(method, catch, js_name = getAuthToken)]
    fn get_auth_token_with_details_and_callback(
        this: &Identity,
        details: &JsValue,
        callback: &Function,
    ) -> Result<(), JsValue>;
